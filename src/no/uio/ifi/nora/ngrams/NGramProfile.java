 ...
 */
// Adapted from Apache Nutch project
...
public class NGramProfile {
  ...
  public static NGramProfile create(String name, InputStream is, String encoding) {
    ...
    {
      System.err.println("Could not create language profile\n" + e.getMessage());
    }
  ...
  public static void main(String args[]) {
    ...
    {
    	System.err.println("Got exception in" + e.getMessage());
